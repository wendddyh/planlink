$venues_array = [
  ...
  {
    "name": "The Wool Mill",
    "description": "A versatile event space located in Brunswick, offering an industrial-chic ambiance that can be tailored for weddings, corporate events, and private parties.",
  ...
  {
    "name": "The Cluster - Meeting and Event Spaces",
    "description": "Situated in Melbourne's CBD, The Cluster provides stylish and modern meeting rooms and event spaces suitable for workshops, seminars, and corporate functions.",
  ...
  {
    "name": "The Albion Rooftop",
    "description": "Offers a picturesque rooftop setting with views of the city skyline, perfect for cocktail parties, birthdays, and special celebrations.",
  ...
  {
    "name": "Fawkner Bowling Club",
    "description": "Provides a relaxed atmosphere with bowling greens and function spaces available for hire, suitable for casual events or gatherings.",
  ...
  {
    "name": "Lucky Strike Melbourne Central",
    "description": "A bowling alley and entertainment center offering party packages and event spaces for corporate events, birthday parties, and social gatherings.",
  ...
  {
    "name": "Heroes Karaoke Bar",
    "description": "Provides private karaoke rooms for hire, ideal for birthday parties, group gatherings, and fun nights out.",
  ...
  {
    "name": "The Emerson Rooftop Bar and Club",
    "description": "A popular rooftop bar and club in South Yarra, offering versatile spaces suitable for private functions, birthdays, and cocktail parties.",
  ...
  {
    "name": "The Deck at Circa",
    "description": "Situated in St Kilda, offering a stunning view of Port Phillip Bay and providing a sophisticated setting for weddings, cocktail parties, and special occasions.",
  ...
  {
    "name": "The Substation",
    "description": "An arts and cultural center located in Newport, offering unique and historic spaces that can be hired for events, performances, and exhibitions.",
  ...
  {
    "name": "The Abbotsford Convent",
    "description": "A heritage-listed precinct in Abbotsford, offering various venues and spaces for hire, including gardens, galleries, and function rooms for weddings, events, and workshops.",
  ...
  {
    "name": "Meat Market",
    "description": "Located in North Melbourne, this historic building offers versatile event spaces suitable for weddings, corporate functions, and cultural events.",
    "category": "Event Venue",
  ...
  {
    "name": "Cargo Hall",
    "description": "A stylish waterfront venue in South Wharf offering versatile event spaces with waterfront views, suitable for weddings, corporate functions, and special events.",
  ...
  {
    "name": "Eureka Skydeck Edge Experience",
  ...
  {
    "name": "Trees Adventure / Enchanted Adventure Garden",
  ...
  {
    "name": "Le Mans Go Karts Melbourne",
  ...
  {
    "name": "Clip 'n Climb Melbourne - Warrior Challenge Course",
  ...
  {
    "name": "Sorrento Sailing & Couta Boat Club",
